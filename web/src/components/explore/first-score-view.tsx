...
const SEEN_KEY = "hirecute:first-score-seen";
        ...
        <div className="relative px-7 pb-7 pt-8">
          ...
          <div className="mt-4 flex items-start gap-4">
            <div className="min-w-0 flex-1">
              <h2 className={`${GeistSans.className} truncate text-2xl leading-tight text-foreground`}>{role || company}</h2>
          ...
          <blockquote className={`${GeistSans.className} mt-5 border-l-2 border-primary/40 pl-4 text-[19px] leading-snug text-foreground`}>
