...
// Soft budgets (tunable via localStorage `hirecute:usage-budget`). The bar
...
export function UsageMeter() {
  ...
  useEffect(() => {
    try {
      const cfg = localStorage.getItem("hirecute:config");
      setCli(cfg ? JSON.parse(cfg).cliId || null : null);
      const b = localStorage.getItem("hirecute:usage-budget");
