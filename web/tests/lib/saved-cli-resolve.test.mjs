...
// CONFIG_KEY comes from the module under test rather than being restated
// here: duplicating the literal is what let it drift when the localStorage
// namespace was rebranded.
const { resolveCliId, CONFIG_KEY } = await import("../../src/lib/saved-cli.ts");
